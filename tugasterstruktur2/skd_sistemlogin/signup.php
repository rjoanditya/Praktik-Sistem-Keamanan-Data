...
<!-- 
pattern="(?=.*\d)(?=.*[!@#$%^&*_=+-])(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Harus 8 atau lebih karakter, memiliki setidaknya 1 huruf kapital dan huruf kecil, harus terdapat angka, dan harus memiliki karakter spesial(!@#$%^&*_=+-)"
