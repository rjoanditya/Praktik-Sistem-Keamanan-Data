...
//mengubah plaintext & kunci menjadi sebuah array
    ...
    $key        = str_split($kunci);
//menghitung jumlah array secara normal
    $m          = count($key);
    $n          = count($plaintext);
//mendefinisikan batas dan hasil encrypted awal
    $bataskode  = 65;
    $bataslow   = 97;
    $encrypted_text = '';
...
//proses enkripsi
//ord mengubah ascii menjadi desimal
//chr mengubah desimal menjadi ascii    
